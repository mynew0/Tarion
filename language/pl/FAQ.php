...
$LNG['questions'][1][1]['title']	= 'Część 1: Trudne Początki';
...
$LNG['questions'][2][1]['title']	= 'Atakowanie innych graczy';
...
<ul>
	<li>A. Farmienie</li>
	<li>B. Polowanie na flotę</li>
	<li>C. Pola zniszczeń</li>
	<li>D. Przechwytywanie </li>
</ul>
<h3>A. Farmienie:</h3>
...
<h3>B. Najlepszą metodą obrony są odpowiednie fleet save</h3>
...
<h3>C. Zapotrzebowanie na deuterium w czasie postoju na obcej planecie (1h postoju to ilość jednostek :</h3>
...
$LNG['questions'][2][4]['title']	= 'Księżyce';
...
<h3>A. Jak mogę założyć sojusz?</h3>
