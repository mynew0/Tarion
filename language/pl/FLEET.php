...
$LNG['sys_expe_found_ress_1_4']				= 'Ekspedycja odkryła radioaktywną planetoide. Za pomocą statków bezzałogowych wydobyto z niej co tylko się dało. <br> <b>Misja: Wykonana</b> ';
$LNG['sys_expe_found_ress_2_1']				= 'Ekspedycja znalazła starożytny frachtowiec, udało się zebrać część surowców. <br><b>Misja: Wykonana</b> ';
$LNG['sys_expe_found_ress_2_2']				= 'Twoja ekspedycja trafiła na mały księżyc pełen cennych zasobów. Starają się wydobyć wszystko. <br><b>Misja: Wykonana</b>';
$LNG['sys_expe_found_ress_2_3']				= 'Spotkaliśmy mały konwój statków cywilnych. W zamian za zapas żywności i leków otrzymaliśmy zasoby. <br><b>Misja: Wykonana</b>';
$LNG['sys_expe_found_ress_3_1']				= 'Twoja ekspedycja natrafiła na gigatyczny wrak obcych, niestety poziom technologii znacznie przewyższa twoją, zatem zdecydowana pociąć go na kawałki i zebrać co się da.';
$LNG['sys_expe_found_ress_3_2']				= 'Pas asteroid wokół nieznanej planety zawiera mase jednego surowca. Ekspedycja wraca z pełnymi magazynami.';
$LNG['sys_expe_found_dm_1_1']				= 'Ekspedycja trafiła na niewielkie ilości Dark Metter-u. <br><b>Misja: Wykonana</b>';
$LNG['sys_expe_found_dm_1_2']				= 'Natkneliśmy się na statek widmo. Mimo iż nie udało się ustalić co przytrafiło się załodze, nasi technicy zebrali cały znaleziony zapas Dark Metter-u.';
$LNG['sys_expe_found_dm_1_3']				= 'Spotkaliśmy mały statek obcych, którzy wzamian za kilka obliczeń matematycznych zostawił mały kontener z Dark Metter-em.';
$LNG['sys_expe_found_dm_1_4']				= 'Znaleźliśmy wrak statku obcych, z małym kontenerem Dark Metter-u.';
$LNG['sys_expe_found_dm_1_5']				= 'Ekspedycja trafiła na dziwny sygnał, podążając za nim odkryli małą ateroidę której rdzeń to Dark Metter. Asteroide zabrano na pokład by zajeli się nią pokładowi naukowcy .';
$LNG['sys_expe_found_dm_2_1']				= 'Twojej ekspedycji powiódł się eksperyment, pozyskałeś Dark Metter z gasnącej gwiazdy.';
$LNG['sys_expe_found_dm_2_2']				= 'Twoja ekspedycja wykryła dziwne zjawisko spektralne. Okazało się że w kontaktcie z osłonami z promieniowania wytraca się Dark Metter, twoi technicy starają się utrzymać to zjawisko jak najdłużej.';
$LNG['sys_expe_found_dm_2_3']				= 'Ekspedycja trafiła na starożytną kompletnie zapuszczoną stacje kosmiczną dryfującą w przestrzeni. Stacja jest bezużyteczna ale reaktor zawiera wciąż Dark Metter. Technicy pracują nad wydobyciem.';
$LNG['sys_expe_found_dm_3_1']				= 'Spontanicze zniekształcenie Hiperprzestrzeni ujawniło duże zasoby Dark Metter-u!';
$LNG['sys_expe_found_dm_3_2']				= 'Ekspedycja nawiązała kontakt z inną cywilizacja, w przestrzeni spotkali osobnika który zwał sie Legorianer, który powstanowił wspomóc nieco naszą słabiej rozwiniętą cywilizacje przekazując pojemnik z Dark Metter-em!';
...
$LNG['sys_expe_found_ships_1_2']			= 'Trafiliśmy na opuszczoną baze piratów. Okazało się że w hangarze jeszcze stoją statki, technicy pracują nad ich uruchomieniem.';
$LNG['sys_expe_found_ships_1_3']			= 'Nasza wyprawa trafiła na prawie kompletnie zniszczoną wojną planete. Z wraków na orbicie technicy próbują coś odzyskać, jak również dowiedzieć się co tu się stało.';
$LNG['sys_expe_found_ships_1_4']			= 'Trafiono na dryfującą wiele lat fortece, jak się okazało w hangarze są jeszcze statki, technicy próbują uruchomić co niektóre.';
$LNG['sys_expe_found_ships_2_1']			= 'Trafiliśmy na szczątki armady, technicy natychmiast zajeli się tymi statkami które jeszcze dobrze wygladają';
$LNG['sys_expe_found_ships_2_2']			= 'Ekspedycja trafiła na dryfującą automatyczną stocznie. Po dostarczeniu jej energi udało się doprowadzić do końca budowe.'; 
$LNG['sys_expe_found_ships_3_1']			= 'Znaleźliśmy gigantyczne cmentarzystko floty. Technicy sprawdzają czy da się coś uratować.';
$LNG['sys_expe_found_ships_3_2']			= 'Odkryliśmy planete z pozostałością cywilizacji, a na orbicie ogromną stocznie. Część techników i pilotów udała się by poszukać czy nie da się czegoś uratować.';
$LNG['sys_expe_lost_fleet_1']				= 'Wyprawa trafiła na dziwny sygnał radiowy,  Zzzrt Boże ... zzrrrttt.. co ...byyyyooo.... do.... sygnał się urwał. <br><b>Misja: Niewykonana</b>';
...
$LNG['sys_expe_time_slow_1']				= 'Niedoświadczony nawigator doprowadził do błedu podczas skoku, nie dość żę wysłał flote nie tam gdzie trzeba to jeszcze znacznie wydłuży się jej powrót.';
$LNG['sys_expe_time_slow_2']				= 'Do tej pory niewiadomo dlaczego skok kompletnie się nie udał, flota wyszła z nadprzestrzeni niemal w sercu słońca... Powrót floty się opuźni.';
$LNG['sys_expe_time_slow_3']				= 'Podczas testów nowego modułu nawigacji coś poszło nie tak. Flota została wysłana nie do końca wiadomo gdzie, a do tego został żużyty prawie cały zapas paliwa. Flota powolutku wraca, ale zajmnie jej to dużo czasu.';
